...
for fileName in "update-docker-assets-file.sh" "dock-helpers.sh" "docker-compose.yml" "docker-jenkins-start.sh" "dock.sh" "stacks.sh" "lighthouse.sh"
do
...
chmod a+x dock.sh
chmod a+x update-docker-assets-file.sh
